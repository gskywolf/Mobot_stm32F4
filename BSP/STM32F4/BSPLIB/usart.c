...
void PB_USART_Init(uint8_t USART_Channel , uint32_t BaudRate , uint8_t GPIO_AF)
{
    ...
    USART_InitStructure.USART_BaudRate = BaudRate ;  //set baud rate 9600 115200 256000 921600
...
void PB_USART_Put_Char(uint8_t USART_Channel , uint8_t Tx_Byte)
{
    USART_TypeDef* USARTx;
...
void PB_USART_printf(USART_TypeDef* USARTx , const char * Data , ...)
{
    const char *s;
    int d;
    char buf[16];
