#ifndef PIBOT_DIFFERENTIAL_2WD_H_
#define PIBOT_DIFFERENTIAL_2WD_H_
...
1-------------------2
*/
class Differential2WD :	public Model{
public:
	Differential2WD() {}
	Differential2WD(float _wheel_radius, float _body_radius) : Model(_wheel_radius, _body_radius) {}
	
	void motion_solver(float* robot_speed, float* motor_speed){
		//	robot_speed[0] x	robot_speed[1] y	robot_speed[2] z
		motor_speed[0] = (-robot_speed[0] + robot_speed[2] * body_radius)/ wheel_radius;//left motor
		motor_speed[1] = (robot_speed[0] + robot_speed[2] * body_radius) / wheel_radius;//right motor
    }
