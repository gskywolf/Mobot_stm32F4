...
public:
	...
	void motion_solver(float* robot_speed, float* motor_speed){
		...
		motor_speed[0] = (robot_speed[1] + robot_speed[2] * body_radius)/ wheel_radius;											//left motor
		motor_speed[1] = (-robot_speed[0]*sqrt_of_3*0.5 - robot_speed[1]*0.5 + robot_speed[2] * body_radius) / wheel_radius;	//right motor
		motor_speed[2] = (robot_speed[0]*sqrt_of_3*0.5 - robot_speed[1]*0.5 + robot_speed[2] * body_radius) / wheel_radius;		//front motor
    }
